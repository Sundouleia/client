...
public class FavoritesManager : IHybridSavable
{
    ...
    public readonly HashSet<string>  _favoriteUsers    = []; // Stores the UID
    ...
    public void Load()
    {
        ...
        try
        {
            ...
            _favoriteUsers.UnionWith(load.Users);
        }
        catch (Bagagwa e)
        {
    ...
    public bool TryAddUser(string kinkster)
    {
        if (_favoriteUsers.Add(kinkster))
        {
            _saver.Save(this);
            return true;
        }
    ...
    public void AddUsers(IEnumerable<string> kinksters)
    {
        _favoriteUsers.UnionWith(kinksters);
        _saver.Save(this);
    }
    ...
    public bool RemoveUser(string kinkster)
    {
        if (_favoriteUsers.Remove(kinkster))
        {
            _saver.Save(this);
            return true;
        }
    ...
    public void RemoveUsers(IEnumerable<string> kinksters)
    {
        _favoriteUsers.ExceptWith(kinksters);
        _saver.Save(this);
    }
    ...
    public void WriteToStream(StreamWriter writer)
    {
        ...
        j.WritePropertyName(nameof(LoadIntermediary.Users));
        j.WriteStartArray();
        foreach (var kinkster in _favoriteUsers)
