...
using Sundouleia.State.Caches;
using Sundouleia.State.Models;

namespace Sundouleia.State.Managers;
public unsafe class VfxSpawnManager : DisposableMediatorSubscriberBase
{
    private readonly SpatialAudioCache _cache;
    public VfxSpawnManager(ILogger<VfxSpawnManager> logger, SundouleiaMediator mediator, SpatialAudioCache cache)
