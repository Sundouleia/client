namespace Sundouleia.WebAPI.Files
{
    ...
    internal class ThrottledStream : Stream
    {
        ...
        private static long MaxBandwidthLimit => 10_000_000; // 10MB/s / 80Mbps
...
#pragma warning disable CS8618 // Handled by BandwidthLimit setter
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        public long BandwidthLimit
        {
            ...
            set
            {
                var newValue = Math.Min(value, MaxBandwidthLimit);
                if (_bandwidthLimit == newValue) return;
                _bandwidthLimit = newValue <= 0 ? MaxBandwidthLimit : newValue;
...
{
    public static async Task CopyToAsync(this Stream source, Stream destination, IProgress<long> progress, CancellationToken cancellationToken = default, int bufferSize = 0x1000)
    {
