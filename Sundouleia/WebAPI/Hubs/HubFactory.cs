...
public class HubFactory : MediatorSubscriberBase
{
    ...
    public async Task DisposeHubAsync()
    {
        ...
        Logger.LogDebug("Disposing current connection with SundouleiaHub-Main", LoggerType.HubFactory);
        ...
        _instance = null;
        Logger.LogDebug("SundouleiaHub-Main Finished Disposing", LoggerType.HubFactory);
    }
    ...
    {
        Mediator.Publish(new ClosedMessage(arg));
