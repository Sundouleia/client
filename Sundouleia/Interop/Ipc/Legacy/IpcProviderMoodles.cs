...
//        var sm = LociManager.GetFromChara((Character*)player.Address);
...
//        var manager = LociManager.GetFromChara(chara);
//        return manager.Statuses.Select(s => s.ToTuple().ToLegacyTuple()).ToList();
//    }
...
//        if (!CharaWatcher.TryGetValue(addr, out Character* chara))
//            return string.Empty;
//        var legacyStatuses = LociManager.GetFromChara(chara).Statuses.Select(s => s.ToLegacyStatus());
//        return ToBase64(legacyStatuses.ToList());
//    }
...
//    // Setter helpers.
//    public void Apply(ActorSM sm, byte[] data)
//    {
//        Generic.Safe(() =>
//        {
