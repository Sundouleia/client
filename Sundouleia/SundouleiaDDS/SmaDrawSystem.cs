...
public sealed class SmaDrawSystem : DynamicDrawSystem<RadarPublicUser>, IMediatorSubscriber, IDisposable, IHybridSavable
{
    ...
    public SmaDrawSystem(ILogger<RadarDrawSystem> logger, SundouleiaMediator mediator,
